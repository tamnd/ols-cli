...
Most of these come down to network reality or how ols serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ols rate-limits like any public site. ols already paces
...
Where a surface is gated, ols reads a cookie or token you supply
...
`ols`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ols actually did
